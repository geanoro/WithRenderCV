...
\usepackage[
    pdftitle={Gianmarco Gamo32aasdassda's CV},
    pdfauthor={Gianmarco Gamo32aasdassda},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Gianmarco Gamo32aasdassda - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \textbf{Gianmarco Gamo32aasdassda}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}Brescia}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{BSds}}{
            Sept 2000 – May 2005
        }
    ...
    \section{Experience}
        ...
        5 months
            ...
            \textbf{Tecnosens}, Software Engineer
            \begin{highlights}
                \item sfruttato
                \item sottopagato
                \item se stai leggendo sto scherzando
            \end{highlights}
        \end{twocolentry}
