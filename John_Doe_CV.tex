...
\usepackage[
    pdftitle={Gianmarco Gamo32aasdas's CV},
    pdfauthor={Gianmarco Gamo32aasdas},
...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small Gianmarco Gamo32aasdas - Page \thepage{} of \pageref*{LastPage}}
